...
constexpr float ALLOWED_DISTANCE_FROM_CENTER = 20000.0f;
...
{
    return (pos.fX >= -ALLOWED_DISTANCE_FROM_CENTER && pos.fX <= ALLOWED_DISTANCE_FROM_CENTER && pos.fY >= -ALLOWED_DISTANCE_FROM_CENTER &&
            pos.fY <= ALLOWED_DISTANCE_FROM_CENTER);
}
